...
do
    ...
    function utility:protectedGui(ScreenGui)
        if syn and syn.protect_gui or protect_gui then (syn.protect_gui or protect_gui)(ScreenGui) else
            if getconnections then
                ...
                cleancons(ScreenGui.DescendantAdded)
                cleancons(ScreenGui.ChildAdded)
                cleancons(game:GetService"CoreGui".DescendantAdded)
...
do
	...
	function library.new(title)
        ...
        utility:protectedGui(container)
